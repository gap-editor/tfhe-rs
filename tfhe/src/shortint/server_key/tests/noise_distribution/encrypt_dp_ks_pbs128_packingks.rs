...
#[allow(clippy::too_many_arguments)]
fn encrypt_dp_ks_standard_pbs128_inner_helper(
    ...
    let (input, after_dp, after_ks, after_drift, after_ms, after_pbs128) = dp_ks_standard_pbs128(
        ct.ct,
...
#[allow(clippy::too_many_arguments)]
fn encrypt_dp_ks_standard_pbs128_noise_helper(
    params: AtomicPatternParameters,
    noise_squashing_params: NoiseSquashingParameters,
    single_cks: &ClientKey,
    single_sks: &ServerKey,
    ...
    let (input, after_dp, after_ks, after_drift, after_ms, after_pbs128) =
        encrypt_dp_ks_standard_pbs128_inner_helper(
            params,
...
fn noise_check_encrypt_dp_ks_standard_pbs128_noise<P>(
    params: P,
    noise_squashing_params: NoiseSquashingParameters,
) where
    P: Into<AtomicPatternParameters>,
{
    ...
    let noise_simulation_bsk128 =
        NoiseSimulationLweStandardBsk128::new_from_parameters(params, noise_squashing_params);
        ...
        let current_noise_samples_after_pbs128: Vec<_> = (0..sample_count_per_msg)
            ...
            .map(|_| {
                let (_input, _after_dp, _after_ks, _after_drift, _after_ms, after_pbs128) =
                    encrypt_dp_ks_standard_pbs128_noise_helper(
                        params,
                        noise_squashing_params,
                        &cks,
                        &sks,
...
#[test]
fn test_noise_check_encrypt_dp_ks_standard_pbs128_noise_param_message_2_carry_2_ks_pbs_tuniform_2m128(
) {
    noise_check_encrypt_dp_ks_standard_pbs128_noise(
        TEST_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
        TEST_PARAM_NOISE_SQUASHING_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    )
}
